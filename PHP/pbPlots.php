...
function ScatterPlotFromSettingsValid($settings, $errorMessage){
  ...
  if( !$settings->xAxisAuto ){
    if($settings->xAxisTop && $settings->xAxisBottom){
      $success = false;
      $errorMessage->string = str_split("x-axis not automatic and configured to be both on top and on bottom.");
    }
    if( !$settings->xAxisTop  &&  !$settings->xAxisBottom ){
      $success = false;
      $errorMessage->string = str_split("x-axis not automatic and configured to be neither on top nor on bottom.");
    }
  }
  ...
  if( !$settings->yAxisAuto ){
    if($settings->yAxisLeft && $settings->yAxisRight){
      $success = false;
      $errorMessage->string = str_split("y-axis not automatic and configured to be both on top and on bottom.");
    }
    if( !$settings->yAxisLeft  &&  !$settings->yAxisRight ){
      $success = false;
      $errorMessage->string = str_split("y-axis not automatic and configured to be neither on top nor on bottom.");
    }
  }
  ...
  for($i = 0.0; $i < count($settings->scatterPlotSeries); $i = $i + 1.0){
    ...
    if(count($series->xs) != count($series->ys)){
      $success = false;
      $errorMessage->string = str_split("x and y series must be of the same length.");
    }
    if(count($series->xs) == 0.0){
      $success = false;
      $errorMessage->string = str_split("There must be data in the series to be plotted.");
    }
    if($series->linearInterpolation && count($series->xs) == 1.0){
      $success = false;
      $errorMessage->string = str_split("Linear interpolation requires at least two data points to be plotted.");
    }
  }
  ...
  if( !$settings->autoBoundaries ){
    if($settings->xMin >= $settings->xMax){
      $success = false;
      $errorMessage->string = str_split("x min is higher than or equal to x max.");
    }
    if($settings->yMin >= $settings->yMax){
      $success = false;
      $errorMessage->string = str_split("y min is higher than or equal to y max.");
    }
  }
  ...
  if( !$settings->autoPadding ){
    if(2.0*$settings->xPadding >= $settings->width){
      $success = false;
      $errorMessage->string = str_split("The x padding is more then the width.");
    }
    if(2.0*$settings->yPadding >= $settings->height){
      $success = false;
      $errorMessage->string = str_split("The y padding is more then the height.");
    }
  }
  ...
  if($settings->width < 0.0){
    $success = false;
    $errorMessage->string = str_split("The width is less than 0.");
  }
  if($settings->height < 0.0){
    $success = false;
    $errorMessage->string = str_split("The height is less than 0.");
  }
  ...
  for($i = 0.0; $i < count($settings->scatterPlotSeries); $i = $i + 1.0){
    ...
    if($series->lineThickness < 0.0){
      $success = false;
      $errorMessage->string = str_split("The line thickness is less than 0.");
    }
    ...
    if( !$series->linearInterpolation ){
      ...
      if( !$found ){
        $success = false;
        $errorMessage->string = str_split("The point type is unknown.");
      }
    }else{
      /* Line type. */
      $found = false;
      ...
      if( !$found ){
        $success = false;
        $errorMessage->string = str_split("The line type is unknown.");
      }
    }
  }
...
function BarPlotSettingsIsValid($settings, $errorMessage){
  ...
  for($i = 0.0; $i < count($settings->barPlotSeries); $i = $i + 1.0){
    ...
    if( !$lengthSet ){
      ...
      $success = false;
      $errorMessage->string = str_split("The number of data points must be equal for all series.");
    }
  }
  ...
  if( !$settings->autoBoundaries ){
    if($settings->yMin >= $settings->yMax){
      $success = false;
      $errorMessage->string = str_split("Minimum y lower than maximum y.");
    }
  }
  ...
  if( !$settings->autoPadding ){
    if(2.0*$settings->xPadding >= $settings->width){
      $success = false;
      $errorMessage->string = str_split("Double the horizontal padding is larger than or equal to the width.");
    }
    if(2.0*$settings->yPadding >= $settings->height){
      $success = false;
      $errorMessage->string = str_split("Double the vertical padding is larger than or equal to the height.");
    }
  }
  ...
  if($settings->width < 0.0){
    $success = false;
    $errorMessage->string = str_split("Width lower than zero.");
  }
  if($settings->height < 0.0){
    $success = false;
    $errorMessage->string = str_split("Height lower than zero.");
  }
  ...
  if( !$settings->autoSpacing ){
    if($settings->groupSeparation < 0.0){
      $success = false;
      $errorMessage->string = str_split("Group separation lower than zero.");
    }
    if($settings->barSeparation < 0.0){
      $success = false;
      $errorMessage->string = str_split("Bar separation lower than zero.");
    }
  }
...
function test(){
  ...
  $errorMessage = CreateStringReference($literal = array());
...
function ExampleRegression($image){
  ...
  $xsStr = str_split("20.1, 7.1, 16.1, 14.9, 16.7, 8.8, 9.7, 10.3, 22, 16.2, 12.1, 10.3, 14.5, 12.4, 9.6, 12.2, 10.8, 14.7, 19.7, 11.2, 10.1, 11, 12.2, 9.2, 23.5, 9.4, 15.3, 9.6, 11.1, 5.3, 7.8, 25.3, 16.5, 12.6, 12, 11.5, 17.1, 11.2, 12.2, 10.6, 19.9, 14.5, 15.5, 17.4, 8.4, 10.3, 10.2, 12.5, 16.7, 8.5, 12.2");
  $ysStr = str_split("31.5, 18.9, 35, 31.6, 22.6, 26.2, 14.1, 24.7, 44.8, 23.2, 31.4, 17.7, 18.4, 23.4, 22.6, 16.4, 21.4, 26.5, 31.7, 11.9, 20, 12.5, 18, 14.2, 37.6, 22.2, 17.8, 18.3, 28, 8.1, 14.7, 37.8, 15.7, 28.6, 11.7, 20.1, 30.1, 18.2, 17.2, 19.6, 29.2, 17.3, 28.2, 38.2, 17.8, 10.4, 19, 16.8, 21.5, 15.9, 17.7");
  ...
  $settings->scatterPlotSeries[0.0]->xs = $xs;
  $settings->scatterPlotSeries[0.0]->ys = $ys;
  $settings->scatterPlotSeries[0.0]->linearInterpolation = false;
  $settings->scatterPlotSeries[0.0]->pointType = str_split("dots");
  $settings->scatterPlotSeries[0.0]->color = CreateRGBColor(1.0, 0.0, 0.0);

  /*OrdinaryLeastSquaresWithIntercept(); */
  $xs2 = array_fill(0, 2.0, 0);
  $ys2 = array_fill(0, 2.0, 0);
  ...
  $settings->scatterPlotSeries[1.0]->linearInterpolation = true;
  $settings->scatterPlotSeries[1.0]->lineType = str_split("solid");
  $settings->scatterPlotSeries[1.0]->lineThickness = 2.0;
  $settings->scatterPlotSeries[1.0]->color = CreateRGBColor(0.0, 0.0, 1.0);
...
function BarPlotExample($imageReference){
  ...
  $ys1 = StringToNumberArray($literal = str_split("1, 2, 3, 4, 5"));
  $ys2 = StringToNumberArray($literal = str_split("5, 4, 3, 2, 1"));
  $ys3 = StringToNumberArray($literal = str_split("10, 2, 4, 3, 4"));
  ...
  /*settings.xPadding; */
  /*settings.yPadding; */
  $settings->title = str_split("title");
  $settings->showGrid = true;
  $settings->gridColor = GetGray(0.1);
  $settings->yLabel = str_split("y label");
  $settings->autoColor = true;
  $settings->grayscaleAutoColor = false;
  $settings->autoSpacing = true;
  ...
  $settings->autoLabels = false;
  $settings->xLabels = array_fill(0, 5.0, 0);
  $settings->xLabels[0.0] = CreateStringReference($literal = str_split("may 20"));
  $settings->xLabels[1.0] = CreateStringReference($literal = str_split("jun 20"));
  $settings->xLabels[2.0] = CreateStringReference($literal = str_split("jul 20"));
  $settings->xLabels[3.0] = CreateStringReference($literal = str_split("aug 20"));
  $settings->xLabels[4.0] = CreateStringReference($literal = str_split("sep 20"));
  /*settings.colors; */
  $settings->barBorder = true;

  $settings->barPlotSeries = array_fill(0, 3.0, 0);
  $settings->barPlotSeries[0.0] = GetDefaultBarPlotSeriesSettings();
  $settings->barPlotSeries[0.0]->ys = $ys1;
  $settings->barPlotSeries[1.0] = GetDefaultBarPlotSeriesSettings();
  $settings->barPlotSeries[1.0]->ys = $ys2;
  $settings->barPlotSeries[2.0] = GetDefaultBarPlotSeriesSettings();
  $settings->barPlotSeries[2.0]->ys = $ys3;
...
function &CreateStringScientificNotationDecimalFromNumberAllOptions($decimal, $complete){
  ...
  if($complete){
    ...
    if(count($mantissaReference->string) == 1.0){
      $result = AppendString($result, $literal = str_split("."));
      $additional = $additional - 1.0;
    }

    for($i = count($mantissaReference->string); $i < $additional; $i = $i + 1.0){
      $result = AppendString($result, $literal = str_split("0"));
    }
  }
  ...
  if($complete){
    for($i = count($exponentReference->string); $i < 2.0; $i = $i + 1.0){
      $result = AppendString($result, $literal = str_split("0"));
    }
  }
...
function &DigitDataBase16(){
  return str_split("");
}
...
function &GetPixelFontData(){
  return str_split("");
}
